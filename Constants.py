class Constants:
    ...
    if TEST_SERVER:
        ...
        GUILD_ID =1202306050578190356 #Guild ID of the discord server
        ...
        CB_NOTIFICATION_CHANNEL_ID = 1202306050578190356
        FANS_NOTIFICATION_CHANNEL_ID = 1202306050578190356
        OF_NOTIFICATION_CHANNEL_ID = 1061931918414852146
        YT_NOTIFICATION_CHANNEL_ID = 1202306050578190356
        TWITCH_NOTIFICATION_CHANNEL_ID = 1202306050578190356
        CAM4_NOTIFICATION_CHANNEL_ID = 1202306050578190356
        MFC_NOTIFICATION_CHANNEL_ID = 1202306050578190356
        BC_NOTIFICATION_CHANNEL_ID = 1202306050578190356
        SC_NOTIFICATION_CHANNEL_ID = 1202306050578190356
